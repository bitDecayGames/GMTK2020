...
class Dialogs {
    ...
    public static var DialogArray:Array<Array<String>> = [
        ["Move: WSAD/Arrow Keys", "Run: Shift", "Dive roll: Z/Space - You can dive over cars.", "Ugh its raining... and its cold...", "Gotta get some cigs.", "The compass points to your next objective.", "Click book at bottom right to view all objectives", ],
